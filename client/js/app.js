    ...
    $scope.seeVis = (rulesID) => {
      ...
      $http
        ...
        .success(function (dataActions) {
          ...
          $http
            .get(`/api/v2/rules/selectOneRule/${rulesID}`)
            .success(function (detailRule) {
...
app.controller(
  ...
  function ($window, $scope, $location, $routeParams, $http, socket) {
    ...
    $scope.seeRule = (idRule) => {
      ...
      $http
        .get(
          `/api/v2/rules/selectOneRule/${idRule}?id_session=${$scope.sessionid}`
        )
        .success((detailRule) => {
          $scope.detailRule = detailRule;
...
app.controller(
  ...
  function ($scope, $location, $routeParams, $http, socket) {
    ...
    $scope.createNetwork = (idRule) => {
      ...
      $http
        .get(
          `/api/v1/visualisations/bringGraph/${idRule}?id_session=${$scope.sessionid}`
        )
        .success(function (data) {
          //$scope.sessionRules = data;
